 ...
 *  Adelson-Velsky and Evgenii Landis' tree) which is a self-balancing BinarySearchTree.
...
public class AVLTreeST<Key extends Comparable<Key>, Value> {
    ...
    /**
     * Checks if the tree rooted at x is a BinarySearchTree with all keys strictly between
